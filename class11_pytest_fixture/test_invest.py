...
from class11_pytest_fixture.datas import login_data,bid_data
from class11_pytest_fixture.pages.bid_page import BidPage
from class11_pytest_fixture.pages.index_page import IndexPage
