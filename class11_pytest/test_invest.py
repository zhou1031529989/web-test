...
from class11_pytest.datas import login_data,bid_data
from class11_pytest.pages.bid_page import BidPage
from class11_pytest.pages.index_page import IndexPage
